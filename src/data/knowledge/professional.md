...
**Company Context:** Large healthcare system, now part of CommonSpirit Health
**Role Overview:** Managed a team of 25 nurses across 8 locations while developing internal tools and communication frameworks

**Key Responsibilities:**

- Managed a team of 25 nurses working for 42 doctors in 8 locations across Colorado
- Designed and built internal SharePoint website establishing clear, standardized communication
- Developed and implemented standardized communication frameworks

**Technologies Used:** SharePoint, Microsoft Office Suite, Healthcare management systems
**Notable Projects:**

- SharePoint Website: Created internal communication platform with shared resources
- Communication Framework: Developed standardized communication systems

**Achievements:**

- Optimized staffing allocations while maintaining budget constraints
- Eliminated dangerous information gaps between facilities through communication frameworks
- Significantly improved patient satisfaction scores and reduced medical errors

### Early Career / Other Relevant Experience

**Cardiac RN (March 2017 - November 2021):** Accelerated recovery of 900+ patients, mastered efficient care delivery while ensuring meaningful patient connections, developed critical thinking skills for complex cardiac challenges

**Telemetry Tech (July 2016 - March 2017):** Monitored and interpreted cardiac rhythms in real-time, demonstrated exceptional pattern recognition skills, provided critical clinical information impacting patient survival outcomes
...
**Project Overview:** Developed intuitive UI for genomics software that significantly improved user engagement and search functionality
**Technical Challenge:** Implementing real-time search across 500,000+ database entries with millisecond response times
**Your Contribution:** Built React/Redux frontend, implemented Trie data structure for search optimization
**Technologies:** React, Redux, PostgreSQL, JavaScript, Trie data structures
**Impact:** 40% increase in user engagement, 60% increase in user satisfaction, millisecond-level search performance
**Key Learnings:** Advanced data structures, performance optimization, and UX collaboration
