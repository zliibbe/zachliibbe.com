...
import { getPaginatedPostsWithImages, getAllCategories, getAllTags } from '@/lib/blog-with-images';
...
export default async function BlogPage({ searchParams }: BlogPageProps) {
  ...
  const { posts, totalPosts, currentPage: page, totalPages } = await getPaginatedPostsWithImages(currentPage, filters);
  const categories = getAllCategories();
  const tags = getAllTags();

  // Helper function to create URL search params with defined values only
  const createSearchParams = (params: Record<string, string | undefined>): string => {
            ...
            <div className={styles.content}>
              <header className={styles.header}>
                ...
                <p className={styles.subtitle}>
                  Thoughts on development, life, and everything in between. 
                  I write about building things, learning new technologies, and the journey of being a developer.
                </p>
              </header>
                  ...
                  {categories.map(category => (
                    <Link
                      ...
                      className={`${styles.filterLink} ${
                        filters.category === category.toLowerCase() ? styles.active : ''
                      }`}
                    >
                      {category}
                    </Link>
...
export const metadata: Metadata = {
  ...
  description: 'Thoughts on development, life, and everything in between. I write about building things, learning new technologies, and the journey of being a developer.',
};