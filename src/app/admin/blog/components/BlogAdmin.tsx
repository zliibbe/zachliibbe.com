                ...
                <div className={styles.emptyState}>
                  ...
                  <h3>
                    {activeTab === 'all' ? 'No posts yet' : 
                     ...
                     activeTab === 'drafts' ? 'No drafts' : 'No scheduled posts'}
                  </h3>
                  <p>
                    ...
                    <div key={post.id} className={styles.postCard}>
                      <div className={styles.postHeader}>
                        ...
                        <div className={styles.postMeta}>
                          <span className={`${styles.postStatus} ${styles[`status${post.status.charAt(0).toUpperCase() + post.status.slice(1)}`]}`}>
                      ...
                      <div className={styles.postFooter}>
                        <div className={styles.postTags}>
                          {post.categories.concat(post.tags).slice(0, 3).map(tag => (
