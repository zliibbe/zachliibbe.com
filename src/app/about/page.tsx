          ...
          <div className={styles.contentWrapper}>
            <div className={styles.content}>
              ...
              <div className={styles.introAndRecentContainer}>
                <div className={styles.introSection}>
                  ...
                  <p className={styles.paragraph}>
                    My name is Zach and I&apos;m glad you&apos;ve somehow ended
                    up here.
                  </p>
                  <p>
                  ...
                  <p className={styles.paragraph}>
                    ...
                    and design work brings - solving both technical challenges
                    and user experience puzzles in the same project.
                  </p>
                </div>
                ...
                <div className={styles.recentSection}>
                  ...
                  <li className={styles.recentItem}>
                    ...
                    and there are tears, seeing them push through and experience
                    that moment of triumph at the top of a trail or when they
                    finally get the hang of a new skill makes me incredibly
                    proud.
                  </li>
                  <li className={styles.recentItem}>
                    I&apos;ve been healing up from dislocating my shoulder 😅 at
                    a recent pool party. I somehow disolcated it while diving in
                    to the pool?!
                  </li>
                </div>
              </div>
              ...
              <ul className={styles.listContainer}>
                ...
                <li className={styles.listItem}>
                  Building websites for therapists in order to learn more about
                  my craft, design, and how digital marketing can have a big
                  impact.
                </li>
                <li className={styles.listItem}>
              ...
              <p className={styles.personalNote}>
                Everyone deserves a place on the web to call their own and this
                is my litte spot. I do my best to ensure my spot feels like a
                living, breathing thing. Thanks for stopping by!
              </p>
              <br />
              <br />
